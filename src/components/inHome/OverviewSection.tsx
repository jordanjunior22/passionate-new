    ...
    <section className="w-full bg-neutral-white py-16 md:py-24">
      <div className="container mx-auto max-w-7xl px-4 md:px-8">
        ...
        >
          ...
          Empowering individuals to live independently and safely in their homes by providing personalized support, skill development, and community integration, enhancing their overall quality of life and well-being
          </p>
        </motion.div>
